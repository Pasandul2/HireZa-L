...
<head>
    ...
    <title>Create Job - HireZa Admin</title>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form:form modelAttribute="job" method="post" action="/admin/jobs/create">
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="mb-3">
                                        <label for="title" class="form-label">Job Title <span class="text-danger">*</span></label>
                                        <form:input path="title" class="form-control" id="title" placeholder="e.g. Senior Software Engineer"/>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <form:input path="company" class="form-control" id="company" placeholder="e.g. Tech Solutions Inc"/>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <form:input path="location" class="form-control" id="location" placeholder="e.g. San Francisco, CA"/>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <form:input path="category" class="form-control" id="category" placeholder="e.g. Information Technology"/>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <form:input path="salaryRange" class="form-control" id="salaryRange" placeholder="e.g. $70,000 - $90,000"/>
